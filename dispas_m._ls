...
;;;(alert "disegno carter")
  ...
  (progn
    ...
    (command"_pline" "_non" (setq ptc (list (- (- (+ (CAR pt)  (nth 6 carter_p)) (nth 2 carter)) 20)(+ y_s (nth 7 carter_p)) 0))
...
(if (> (nth 5 carter) 1600)
  ...
  (progn
    ...
    (command"_pline" "_non" (setq ptc (list (+ (+ (nth 2 carter) (- (CAR pt)  (nth 6 carter_p))) 20) (+ y_s (nth 7 carter_p)) 0))
...
(if (= "COR" (nth 11 carter))
  (progn
    ...
    (command"_pline" "_non" pt2c
          ...
          (command"_circle" "_non" (list (+ (/ (nth 2 carter) 2) (car pt2c) -150) (+ (cadr pt2c) 9.7)) 2.5)
      (command"_circle" "_non" (list (+ (/ (nth 2 carter) 2) (car pt2c) 150) (+ (cadr pt2c) 9.7)) 2.5)
